...
- Systems engineering repositories with requirements, interfaces, risks, and verification artifacts
- Host-buildable embedded projects that demonstrate firmware design without hardware dependency
- Python simulation tools for real-time systems, guidance, tracking, and communication analysis
...
GitHub does not support true folder views for profile repositories, so I group the work here by discipline.
...
<details>
<summary><strong>Embedded and Real-Time Systems</strong></summary>
...
<details>
<summary><strong>Tracking, Guidance, and RF Simulation</strong></summary>
...
The strongest repositories in this profile follow the same baseline:

1. A clear one-line value proposition
2. A repository or system map that explains the structure quickly
3. A reproducible quick start with observable output
4. Tests and CI so the repo reads like engineering work, not a document dump
5. Short design notes that explain why the project is portfolio-relevant
