...
<p align="center">
  Portfolio-grade repositories focused on traceability, verification readiness,
...
- [systems-engineering-traceability-lab](https://github.com/akifitu/systems-engineering-traceability-lab)
  Systems engineering repository for requirements, interfaces, risks, and verification linkage.
- [embedded-systems-collection](https://github.com/akifitu/embedded-systems-collection)
  Host-buildable C firmware portfolio covering control, diagnostics, safety, and protection logic.
- [verification-readiness-dashboard](https://github.com/akifitu/verification-readiness-dashboard)
  Static readiness dashboard for closure state, evidence, blockers, and overdue work.
- [embedded-rtos-sim](https://github.com/akifitu/embedded-rtos-sim)
  Preemptive scheduling, semaphores, queues, and defense-style real-time scenarios.

<br />

## Focus

TR: Bu profilin ana odagi sistem muhendisligi, embedded yazilim ve teknik simulasyon calismalari.

EN: Most defense-style scenarios here are fictional and used to demonstrate engineering workflow, architecture reasoning, and technical communication quality.
...
- All repositories:
  [github.com/akifitu?tab=repositories](https://github.com/akifitu?tab=repositories)
